...
const pdfDetailsSchema = new mongoose.Schema({
    ...
    realizableValueWords: { type: String, default: "" },
    distressValue: { type: String, default: "" },
    distressValueWords: { type: String, default: "" },
    jantriValue: { type: String, default: "" },
    jantriValueWords: { type: String, default: "" },
    insurableValue: { type: String, default: "" },
    insurableValueWords: { type: String, default: "" },
    ...
    noModifiedSquadsSGHighway: { type: String, default: "" },
    ...
    greenSpace: { type: String, default: "" },
    ...
    nameOfTheOwners: { type: String, default: "" },
    ...
    agriculturalLandStatus: { type: String, default: "" },
    companyInvolved: { type: String, default: "" },
    confirmUsingMortgageChanges: { type: String, default: "" },
    permissionIsBuildingIncluded: { type: String, default: "" },
    observationInPlan: { type: String, default: "" },
    
    // PAGE 8: DECLARATION DATA
    theChiefManagerOfTheBank: { type: String, default: "" },
    specificationAuthorization: { type: String, default: "" },
    propertiesOfValueLimitedThroughIsGroup: { type: String, default: "" },
    ...
    constructionRate: { type: String, default: "" },
    ...
    depreciatedRatePerSqmt: { type: String, default: "" },
    ...
    roofHeightApprx: { type: String, default: "" },
    estimatedReplacement: { type: String, default: "" },
    ...
    marketValueProperty: { type: String, default: "" },
    realizableValueProperty: { type: String, default: "" },
    realizableValueMarket: { type: String, default: "" },
    distressValueProperty: { type: String, default: "" },
    distressValueMarket: { type: String, default: "" },
    insurableValueProperty: { type: String, default: "" },
    insurableValueMarket: { type: String, default: "" },
    jantriValueProperty: { type: String, default: "" },
    jantriValueMarket: { type: String, default: "" },
    valuationRemarks: { type: String, default: "" },
    
    // PAGE 12: NOTES & GUIDELINES
    variationNotes: { type: String, default: "" },
    guidelineValueDescription: { type: String, default: "" },
    
    // PAGE 12: ADDITIONAL DETAILS
    lastTwoTransactionsDetails: { type: String, default: "" },
    revisedGuidelineRateInfo: { type: String, default: "" },
    remarks: { type: String, default: "" },
    
    // PAGE 12: SUPPORTING DOCUMENTS & FINAL VALUES
    approvedSanctionedPlanCopy: { type: String, default: "" },
    googleMapCoordinates: { type: String, default: "" },
    propertyPriceTrend: { type: String, default: "" },
    guidelineRateDocumentation: { type: String, default: "" },
    otherRelevantDocuments: { type: String, default: "" },
    bookValue: { type: String, default: "" },
    bookValueWords: { type: String, default: "" },
    
    // PAGE 13: SIGNATURE & APPROVAL PAGE
    reportDate: { type: String, default: "" },
    reportPlace: { type: String, default: "" },
    approverDesignation: { type: String, default: "" },
    inspectionCompletionDate: { type: String, default: "" },
    approverDeclaration: { type: String, default: "" },
    fairMarketValueApproval: { type: String, default: "" },
    fairMarketValueApprovalWords: { type: String, default: "" },
    branchManagerNameApproval: { type: String, default: "" },
    branchManagerSignature: { type: String, default: "" },
    branchManagerSealAttached: { type: String, default: "" }
